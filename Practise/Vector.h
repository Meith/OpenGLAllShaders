...
static inline GLfloat vec##n##_dotprod(vec##n const a, vec##n const b) \
{ \
	GLfloat l = 0.0f; \
	GLuint i; \
	for(i=0; i<n; ++i) \
...
static inline GLfloat vec##n##_len(vec##n const a) \
{ \
	return sqrtf(vec##n##_dotprod(a, a)); \
} \
static inline void vec##n##_norm(vec##n r, vec##n const a) \
{ \
